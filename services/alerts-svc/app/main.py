...
def _get_azure_alerts() -> list[dict]:
    ...
    if not sub_id:
        logger.warning("AZURE_SUBSCRIPTION_ID not found. Returning empty alerts.")
        return []
    ...
    try:
        ...
        return [{
            ...
            "cloud": "Azure",
            "resource_id": "api",
            "resource_name": "Alerts API",
            "message": f"Failed to fetch Azure alerts: {str(e)[:50]}",
            "acknowledged": False,
